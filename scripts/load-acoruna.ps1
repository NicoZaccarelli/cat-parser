# load-acoruna.ps1 (basado en load-asturias.ps1 v2 endurecido + loader v3 batch=50)
# Mitigaciones contra cascada ambiental (probadas con 0 FAILED en Madrid+Alicante+Málaga+Murcia):
...
$gzDir     = "E:\canScan\cat\a coruna\15_U_23012026_CAT"
$unzipDir  = "$gzDir\unzipped"
$logsDir   = "E:\canScan\cat\a coruna\logs"
$csvPath   = "$logsDir\acoruna-summary.csv"
$parserDir = "D:\canScan\cat-parser"
$skip      = "15902U_23012026.CAT.gz"  # Archivo dummy: solo header+cola, 0 BI/CO
...
Write-Host "Total municipios: $($files.Count) (A Coruña completa, skip 15902U dummy)"
