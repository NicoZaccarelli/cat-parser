# load-valencia.ps1
# Basado en load-baleares-v2.ps1 (idéntica lógica + rutas Valencia + skip 46900U)
...
$gzDir     = "E:\canScan\cat\valencia\46_U_23012026_CAT"
$unzipDir  = "$gzDir\unzipped"
$logsDir   = "E:\canScan\cat\valencia\logs"
$csvPath   = "$logsDir\valencia-summary.csv"
$parserDir = "D:\canScan\cat-parser"
$skip      = "46900U_23012026.CAT.gz"  # Valencia capital (ya cargado en V3)
...
Write-Host "Total municipios: $($files.Count) (excluye 46900U Valencia capital)"
...
Write-Host ""
Write-Host "================================================================="
Write-Host "=== RESUMEN VALENCIA (excl. 46900U) ==="
