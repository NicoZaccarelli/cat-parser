# load-asturias.ps1 (basado en load-madrid.ps1 v2 endurecido + loader v3 batch=50)
...
$gzDir     = "E:\canScan\cat\asturias\33_U_23012026_CAT"
$unzipDir  = "$gzDir\unzipped"
$logsDir   = "E:\canScan\cat\asturias\logs"
$csvPath   = "$logsDir\asturias-summary.csv"
$parserDir = "D:\canScan\cat-parser"
$skip      = ""  # Asturias sin carga previa: no se salta ningún archivo
...
Write-Host "Total municipios: $($files.Count) (Asturias completa, sin skips)"
