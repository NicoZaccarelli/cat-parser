# load-alicante.ps1 (basado en load-madrid.ps1 v2 endurecido)
# Mitigaciones contra cascada ambiental (probadas en Madrid v2 con 0 FAILED):
...
$gzDir     = "E:\canScan\cat\alicante\03_U_23012026_CAT"
$unzipDir  = "$gzDir\unzipped"
$logsDir   = "E:\canScan\cat\alicante\logs"
$csvPath   = "$logsDir\alicante-summary.csv"
$parserDir = "D:\canScan\cat-parser"
$skip      = ""  # Alicante sin carga previa: no se salta ningún archivo
...
Write-Host "Total municipios: $($files.Count) (Alicante completa, sin skips)"
