# load-malaga.ps1 (basado en load-madrid.ps1 v2 endurecido)
# Mitigaciones contra cascada ambiental (probadas con 0 FAILED en Madrid+Alicante):
...
$csvPath   = "$logsDir\malaga-summary.csv"
$parserDir = "D:\canScan\cat-parser"
$skip      = ""  # Málaga sin carga previa: no se salta ningún archivo
...
Write-Host "Total municipios: $($files.Count) (Málaga completa, sin skips)"
