# load-sevilla.ps1
# Basado en load-barcelona.ps1 (idéntica lógica + rutas Sevilla + skip 41900U)
...
$gzDir     = "E:\canScan\cat\sevilla\41_U_23012026_CAT"
$unzipDir  = "$gzDir\unzipped"
$logsDir   = "E:\canScan\cat\sevilla\logs"
$csvPath   = "$logsDir\sevilla-summary.csv"
$parserDir = "D:\canScan\cat-parser"
$skip      = "41900U_23012026.CAT.gz"  # Sevilla capital (ya cargado en S3)
...
Write-Host "Total municipios: $($files.Count) (excluye 41900U Sevilla capital)"
...
Write-Host ""
Write-Host "================================================================="
Write-Host "=== RESUMEN SEVILLA (excl. 41900U) ==="
